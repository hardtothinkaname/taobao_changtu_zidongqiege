...
def download_pics(urls, prefix_name=""):
    ...
    for my_url in urls:
        ...
        mnet.download_img(r"d:/downPics/pop挂画架/", my_url, str1)
        print(str1 + "已下载！")
        temp1 += 1
...
if __name__ == '__main__':
    ...
    url = "https://item.taobao.com/item.htm?spm=a230r.1.14.61.2d4f73e4iR5oWb&id=521903410792&ns=1&abbucket=16#detail"
    # url = "https://detail.1688.com/offer/561345651056.html?spm=a261y.7663282.0.0.d59b588aI9fP4t"
    url = "https://item.taobao.com/item.htm?id=43384028201&_u=t2dmg8j26111"
    url = "https://item.taobao.com/item.htm?spm=a1z38n.10677092.0.0.173f1debKpnhm3&id=561971118475"
